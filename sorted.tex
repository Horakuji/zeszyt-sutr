...
\par\noindent HACHI DAI RY\=U \dotfill \makebox[1.0cm][r]{\pageref{hachi_dai_ryu}}
...
\par\noindent IDA TEN FU GIN \dotfill \makebox[1.0cm][r]{\pageref{idaten_fugin}}
\par\noindent JAKUSHITSU ZENJI YUIKAI\dotfill \makebox[1.0cm][r]{\pageref{jakushitsu_zenji_yuikai}}
\par\noindent JYA JIN NYU RY\=O SHI\dotfill \makebox[1.0cm][r]{\pageref{dai_segaki}}
